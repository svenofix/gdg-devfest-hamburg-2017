...
GDGs pride themselves on being open, respectful, and inclusive communities. As such, we are committed to provide a friendly, safe and welcoming environment for all, regardless of gender, sexual orientation, ability, ethnicity, socioeconomic status, and religion (or lack thereof). Any behavior disrespecting this is highly unacceptable.
...
- Matthias Friedrich, [gdghhandroid@gmail.com](mailto:gdghhandroid@gmail.com), https://twitter.com/mtthsfrdrch
